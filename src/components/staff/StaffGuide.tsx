  ...
  transaction: {
    ...
    steps: [
      ...
      },
      {
        ...
        target: '[data-guide="transaction-capture-po"]',
        advanceOnClick: true,
        eyebrow: "05 · PO",
        title: "Capture the client PO",
        body: "Open the real PO capture form and match it to the tutorial quote.",
      },
      {
        route: "/staff/po-orders",
        target: '[data-guide="transaction-save-po"]',
        advanceOnClick: true,
        eyebrow: "06 · PO",
        title: "Save the PO",
        body: "Complete the real PO form and click Save. The normal API path creates the linked sales-order draft and marks it tutorial-only.",
      },
      {
        route: "/staff/po-orders",
        target: '[data-guide="nav-field-work"]',
        ...
        body: "Click Field Work to continue the real operational hand-off.",
      },
      {
        route: "/staff/field-work",
        target: '[data-guide="transaction-new-work"]',
        advanceOnClick: true,
        eyebrow: "08 · Work",
        title: "Create field work",
        body: "Use the real field-work form to create the tutorial work item, then continue to inspection capture.",
      },
      {
        route: "/staff/field-work",
        target: '[data-guide="transaction-save-work"]',
        advanceOnClick: true,
        eyebrow: "09 · Work",
        title: "Save the work item",
        body: "Complete the real work-item form and click Save before opening inspections.",
      },
      {
        route: "/staff/field-work",
        target: '[data-guide="nav-inspections"]',
        advanceOnClick: true,
        eyebrow: "10 · Inspect",
        title: "Open inspection capture",
        body: "Click Inspections to open the real checklist capture workspace.",
      },
      {
        route: "/staff/inspections",
        target: '[data-guide="transaction-start-inspection"]',
        advanceOnClick: true,
        eyebrow: "11 · Inspect",
        title: "Start an inspection",
        body: "Select the tutorial work's asset and click Start on the real checklist. Complete the required responses and signature, then continue to Survey Reports.",
      },
      {
        route: "/staff/inspections",
        target: '[data-guide="nav-inspection-reports"]',
        advanceOnClick: true,
        eyebrow: "12 · Report",
        title: "Open report review",
        body: "Click Survey Reports after completing the inspection.",
      },
      {
        route: "/staff/inspection-reports",
        target: '[data-guide="transaction-generate-report"]',
        advanceOnClick: true,
        eyebrow: "13 · Report",
        title: "Generate the assembled report",
        body: "Select the completed tutorial inspection and click the real Generate report action.",
      },
      {
        route: "/staff/inspection-reports",
        target: '[data-guide="nav-billing"]',
        ...
        body: "Open Finance to complete the real invoice step for the tutorial transaction.",
      },
      {
        route: "/staff/billing",
        target: '[data-guide="transaction-new-invoice"]',
        advanceOnClick: true,
        eyebrow: "15 · Invoice",
        title: "Create the invoice",
        body: "Open the real invoice form, enter the tutorial transaction total, and create it through the normal billing path.",
      },
      {
        route: "/staff/billing",
        target: '[data-guide="transaction-create-invoice"]',
        advanceOnClick: true,
        eyebrow: "16 · Invoice",
        title: "Save the invoice",
        body: "Click Create to finish the real quote-to-invoice journey. Tutorial records remain excluded from live metrics.",
      },
      {
        eyebrow: "17 · Finish",
        title: "Transaction walkthrough complete",
        body: "The walkthrough has followed the real quote → PO → field work → inspection → report → billing chain. Select Done to remove tutorial records; a server-side sweep also removes abandoned records after two hours.",
      },
    ],
  },
};
