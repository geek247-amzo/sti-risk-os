...
const nav = [
  ...
  { to: "/staff/voice", label: "Voice", icon: Mic, exact: true, group: "Operate" },
  { to: "/staff/chat", label: "Steve Chat", icon: MessageSquare, exact: true, group: "Operate" },
  { to: "/staff/steve", label: "Steve AI", icon: Bot, exact: false, group: "Operate" },
  { to: "/staff/help", label: "Help Center", icon: CircleHelp, exact: true, group: "System" },
